...
// Custom TZX Duino board features
#define USES_CUSTOM_BOARD   1
#define HAS_VOLUME_CONTROL  1       /*Set if your board has MCP4651xxx digital potentiometer */
#define DIGIPOT_ADR         0x28    /*MCP4651 bus address*/
